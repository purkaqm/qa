...
namespace PSS_Automation
{
    ...
    public class TS_Open_VisualPortal_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_VirtualPortal_page_CodedStep()
        {
            Pages.PS_HomePage.ReviewVisualPortalTab.Click();
            ActiveBrowser.WaitUntilReady();
            
        }
    
        [CodedStep(@"New Coded Step")]
        public void TS_Open_VirtualPortal_page_CodedStep1()
        {
