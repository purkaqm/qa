...
namespace PSS_Automation
{
    ...
    public class TS_Open_Add_Other_Work_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_Add_Project_Page_CodedStep()
        {
            ...
            Pages.PS_HomePage.AddOtherWorkTab.Click(true);
        ...
        {
            Pages.PS_HomePage.PageTitleDiv.Wait.ForContent(FindContentType.InnerText,"Add: Other Work");
