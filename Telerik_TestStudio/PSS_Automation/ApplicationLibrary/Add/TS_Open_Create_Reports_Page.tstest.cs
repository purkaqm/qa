...
namespace PSS_Automation
{
    ...
    public class TS_Open_Create_Reports_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_Dashboard_Page_CodedStep() /// \bug The method name does not make sense
        {
            // Wait for Exists 'DashboardLeftNavDiv'
            Pages.PS_HomePage.AddCreateReportsTab.Wait.ForVisible();
            
        }
    
        [CodedStep(@"Click 'DashItemDiv'")]
        public void TS_Open_Dashboard_Page_CodedStep1() /// \bug The method name does not make sense
        {
            // Click on Dashboard
            Pages.PS_HomePage.AddCreateReportsTab.Click(false);
