...
namespace PSS_Automation
{
    ...
    public class TS_Open_Manage_Measures_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_Manage_Metric_Templates_Page_CodedStep2()
        {
            ...
            Pages.PS_HomePage.PageTitleDiv.BaseElement.Wait.ForCondition((a_0, a_1) => ArtOfTest.Common.CompareUtils.StringCompare(a_0.TextContent, "Measures", ArtOfTest.Common.StringCompareType.Contains), false, null, Manager.Settings.ElementWaitTimeout);
