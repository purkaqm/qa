...
namespace PSS_Automation
{
    ...
    public class TS_UnCheck_IS_Organization_Checkbox : BaseWebAiiTest
    {
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_VerifyObjectTable()
        {
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_VeriftObjectType()
        {
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_VerifyElements()
        {
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_ClickEditLink()
        {
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_VerifyEdit()
        {
            ActiveBrowser.RefreshDomTree();
        ...
        public void TS_UnCheck_IS_Organization_Checkbox_CheckIsOrganization()
        {
            if(Pages.PS_ObjectTypesPage.IsOrganizationCheckBox.Checked)
            {
        ...
        [CodedStep(@"Verify Is Organization status is No")]
        public void TS_UnCheck_IS_Organization_Checkbox_VerifyUnCheck()
        {
            ActiveBrowser.RefreshDomTree();
