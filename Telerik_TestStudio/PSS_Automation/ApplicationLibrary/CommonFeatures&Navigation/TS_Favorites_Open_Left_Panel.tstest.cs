...
namespace PSS_Automation
{
    ...
    public class TS_Favorites_Open_Left_Panel : BaseWebAiiTest
    {
        ...
        public void TS_Review_Open_Left_Panel_CodedStep()
        {
            ...
            Pages.PS_HomePage.FavoritesLeftNavLink.Wait.ForExists();
            Pages.PS_HomePage.FavoritesLeftNavLink.Focus();
