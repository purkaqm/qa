...
namespace PSS_Automation
{
    ...
    public class TS_Login : BaseWebAiiTest
    {
        ...
        public void TS_Login_CodedStep()
        {
           ...
           /// \bug What is the difference between this and Login with given user?
            if(isUserLoggedIn()){
       ...
       public bool isUserLoggedIn(){
        ...
        public void TS_Login_CodedStep1()
        {
