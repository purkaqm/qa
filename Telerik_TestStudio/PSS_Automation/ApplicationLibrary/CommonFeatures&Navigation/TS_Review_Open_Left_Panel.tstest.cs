...
namespace PSS_Automation
{
    ...
    public class TS_Review_Open_Left_Panel : BaseWebAiiTest
    {
        ...
        public void TS_Review_Open_Left_Panel_CodedStep2()
        {
            ...
            Pages.PS_HomePage.NavPanelTitleDiv.AssertContent().TextContent(ArtOfTest.Common.StringCompareType.Contains, "REVIEW");
