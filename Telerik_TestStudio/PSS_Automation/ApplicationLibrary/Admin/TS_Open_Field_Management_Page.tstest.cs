...
namespace PSS_Automation
{
    ...
    public class TS_Open_Field_Management_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_Field_Management_Page_CodedStep()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TS_Open_Field_Management_Page_CodedStep1()
        {
            Pages.PS_HomePage.AdminFieldManagementTabDiv.Click();
