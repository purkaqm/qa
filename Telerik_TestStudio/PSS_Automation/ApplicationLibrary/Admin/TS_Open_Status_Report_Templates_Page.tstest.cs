...
namespace PSS_Automation
{
    ...
    public class TS_Open_Status_Report_Templates_Page : BaseWebAiiTest
    {
        ...
        public void TS_Open_Status_Report_Templates_Page_CodedStep()
        {
        ...
        [CodedStep(@"Click Field Management tab")]
        public void TS_Open_Status_Report_Templates_Page_CodedStep1()
        {
            Pages.PS_HomePage.AdminStatusReportTemplTabDiv.Click();
