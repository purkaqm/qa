...
namespace PSS_Automation
{
    ...
    public class TS_Create_Custom_Field_With_Status_Report_Association : BaseWebAiiTest
    {
        ...
        {
                        string custFieldName = Data["CustomFieldName"].ToString()+Randomizers.generateRandomInt(10000,99999);
        ...
        [CodedStep(@"Choose Created Status Report as Other Association")]
