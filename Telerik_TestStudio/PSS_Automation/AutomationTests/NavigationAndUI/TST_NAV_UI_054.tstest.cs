...
namespace PSS_Automation
{
    ...
    public class TST_NAV_UI_054 : BaseWebAiiTest
    {
        ...
        //public void TST_NAV_UI_054_CodedStep()
        //{
            //Pages.PS_HomePage.ProjectLeftNavLink.Click();
            //ActiveBrowser.WaitUntilReady();
        //}
    
        //[CodedStep(@"Verify user is navigated to project summary page")]
        //public void TST_NAV_UI_054_CodedStep1()
        //{
        ...
        //[CodedStep(@"New Coded Step")]
        //public void TST_NAV_UI_054_CodedStep2()
        //{
            //Assert.IsTrue(Pages.PS_HomePage.NavPanelTitleDiv.InnerText.Contains("REVIEW"));
            
        //}
    
        [CodedStep(@"New Coded Step")]
        public void TST_NAV_UI_054_CodedStep3()
        {
            Pages.PS_ProjectSummaryPage.ProjectSummaryDescendantsDiv.MouseHover();
            ActiveBrowser.WaitForAjax(Manager.Settings.ElementWaitTimeout);
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_NAV_UI_054_CodedStep4()
        {
            ...
            Assert.IsTrue(Pages.PS_ProjectSummaryPage.ProjectSummarySaveBtn.IsVisible());
            Assert.IsTrue(Pages.PS_ProjectSummaryPage.ProjectSummaryDescendantsDiv.IsVisible());
            Assert.IsTrue(Pages.PS_HomePage.NavPanelTitleDiv.InnerText.Contains("PROJECT"));
        }
    }
}
