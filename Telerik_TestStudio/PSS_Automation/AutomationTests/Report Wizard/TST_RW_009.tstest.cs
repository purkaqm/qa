...
namespace PSS_Automation
{
    ...
    public class TST_RW_009 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[TST_RW_009_CS02] : Store Url of Project with best practice 'Yes'")]
        public void TST_RW_009_CS02()
        {
            SetExtractedValue("ProjectUrlYes",ActiveBrowser.Url);
        }
    
        [CodedStep(@"Click on 'Nominate as best practice' link")]
        public void TST_RW_009_CS03()
        {
        ...
        [CodedStep(@"Select 'Nominated on' checkbox")]
        public void TST_RW_009_CS21()
        {
            ActiveBrowser.RefreshDomTree();
            HtmlInputCheckBox nominatedOnChkbox = ActiveBrowser.Find.ByXPath<HtmlInputCheckBox>(AppLocators.get("html_report_nominated_on_chkbox"));
            nominatedOnChkbox.Wait.ForExists();
            nominatedOnChkbox.Click();
        }
    
        [CodedStep(@"Set date range")]
        public void TST_RW_009_CS22()
        {
        ...
        public void TST_RW_009_CS32()
        {
            Assert.IsTrue(ActiveBrowser.Find.AllByXPath(string.Format(AppLocators.get("output_result_report_name"),reportName)).Count > 0);
                                    
        }
    
        [CodedStep(@"Verify 'Nominated on' column is present")]
        public void TST_RW_009_CS33()
        {
            Pages.PS_HtmlReportPage.NominatedOnSpan.Wait.ForExists();
            Assert.IsTrue(Pages.PS_HtmlReportPage.NominatedOnSpan.IsVisible(),"Nominated on column should be present in html report page");
        }
    
        [CodedStep(@"Verify project with 'Nominated on' date is present")]
        public void TST_RW_009_CS34()
        {
            ...
            HtmlSpan resNominatedOnDate = ActiveBrowser.Find.ByXPath<HtmlSpan>(string.Format(AppLocators.get("html_report_approved_on_date"),GetExtractedValue("CreatedProjectName").ToString(),reportDate));
            resNominatedOnDate.Wait.ForVisible(); 
            Assert.IsTrue(resNominatedOnDate.IsVisible(),"Correct date should be display in 'Nominated on' column"); 
        }
    
        [CodedStep(@"Close report html page")]
        public void TST_RW_009_CS35()
        {
