...
namespace PSS_Automation
{
    ...
    public class TSt_RW_004 : BaseWebAiiTest
    {
        ...
        public void TST_RW_004_CS04()
        {
            Pages.PS_NominateAsPopUpWindow.NominateAsPopUpDiv.Wait.ForVisible();
            Pages.PS_NominateAsPopUpWindow.CommentsArea.Wait.ForExists();
        ...
        [CodedStep(@"Set 'Test' project name in comment area")]
        public void TST_RW_004_CS05()
        {
        ...
        [CodedStep(@"Select 'Best practice status' checkbox")]
        public void TST_RW_004_CS24()
        {
            
            HtmlInputCheckBox BestPracStsChkbox = ActiveBrowser.Find.ByXPath<HtmlInputCheckBox>(AppLocators.get("report_wiz_best_prac_status_chkbox"));
            BestPracStsChkbox.Wait.ForExists();
            BestPracStsChkbox.Click();
        }
    
        [CodedStep(@"Select 'All' checkbox in best practice filter")]
        public void TST_RW_004_CS25()
        {
            ActiveBrowser.RefreshDomTree();
            Pages.PS_AddReportWizardPage.AllCheckbox.Click();
        }
    
        
    
        [CodedStep(@"Click on Save button")]
        public void TST_RW_004_CS28()
        {
        ...
        public void TST_RW_004_CS37()
        {
            Assert.IsTrue(ActiveBrowser.Find.AllByXPath(string.Format(AppLocators.get("output_result_report_name"),reportName)).Count > 0);                        
        }
        
        [CodedStep(@"Verify 'Best practice status' column is present")]
        public void TST_RW_004_CS38()
        {
            Pages.PS_HtmlReportPage.BestPracticeSpan.Wait.ForExists();
            Assert.IsTrue(Pages.PS_HtmlReportPage.BestPracticeSpan.IsVisible(),"Best practice status column should be present in html report page");
        }
        
        [CodedStep(@"Verify Project with 'Best practtice status' is present")]
        public void TST_RW_004_CS39()
        {
            string status = "Best";
            ...
            HtmlSpan resBestPractice = ActiveBrowser.Find.ByXPath<HtmlSpan>(string.Format(AppLocators.get("html_report_best_practice_status"),GetExtractedValue("CreatedProjectName").ToString(),status));
            resBestPractice.Wait.ForVisible(); 
            Assert.IsTrue(resBestPractice.IsVisible(),"User name should be present in 'Approved by' column"); 
        }
        
        [CodedStep(@"Close report html page")]
        public void TST_RW_004_CS40()
        {
