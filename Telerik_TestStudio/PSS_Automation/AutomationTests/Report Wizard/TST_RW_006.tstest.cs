...
namespace PSS_Automation
{
    ...
    public class TST_RW_006 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Select 'IS best practice' checkbox")]
        public void TST_RW_006_CS24()
        {
            ActiveBrowser.RefreshDomTree();
            HtmlInputCheckBox isBestPracChkbox = ActiveBrowser.Find.ByXPath<HtmlInputCheckBox>(AppLocators.get("report_wiz_is_best_prac_chkbox"));
            isBestPracChkbox.Wait.ForExists();
            isBestPracChkbox.Click();
        }
    
        [CodedStep(@"Set 'All' selection for best practice filter")]
        public void TST_RW_006_CS25()
        {
            ActiveBrowser.RefreshDomTree();
        ...
        public void TST_RW_006_CS36()
        {
            Pages.PS_HtmlReportPage.IsBestpracticeSpan.Wait.ForExists();
            Assert.IsTrue(Pages.PS_HtmlReportPage.IsBestpracticeSpan.IsVisible(),"Is best practice column should be present in html report page");
        }
    
        [CodedStep(@"Verify Project with 'Best practtice status' is present")]
        public void TST_RW_006_CS37()
        {
            string status = "true";
