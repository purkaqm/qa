...
namespace PSS_Automation
{
    ...
    public class TST_UCO_027 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_027_CS07()
        {
                        Pages.PS_HomePage.ReviewLeftNavLink.Click();
        }
    
        [CodedStep(@"Select file to upload whose required CF value is missed ")]
        public void TST_UCO_027_CS08()
        {
                        string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
                        string importFileToUploadPath = projectPath + "\\Data\\MissingCusFieldValueImportFile.txt";
