...
namespace PSS_Automation
{
    ...
    public class TST_UCO_010 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_010_CS06()
        {
            Pages.PS_HomePage.AddLeftNavLink.Click();
        }
        
        [CodedStep(@"Click on User tab")]
        public void TST_UCO_010_CS07()
        {
            Pages.PS_HomePage.AddUserTab.Click();
            ActiveBrowser.WaitUntilReady();
        }
    
        [CodedStep(@"Verify requires Tag is displayed with red dot")]
        public void TST_UCO_010_CS08()
        {
            ...
            redDotCustumTag.Wait.ForExists();
            Assert.IsTrue(redDotCustumTag.IsVisible());
        }
    
        [CodedStep(@"Delete created custom tag")]
        public void TST_UCO_010_CS09()
        {
        ...
        [CodedStep(@"Break point")]
        public void TST_UCO_010_CS10()
        {
