...
namespace PSS_Automation
{
    ...
    public class TST_UCO_030 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Turn on 'Require default work tree location' at Import New Users (spreadsheet) column")]
        public void TST_UCO_030_CS02()
        {
                        
            Pages.PS_UserCreationOptionsPage.RequireTreeLocatnImportUserChkbox.Check(true);
        }
        ...
        [CodedStep(@"Select file to upload whose required Default Parent column is missed")]
        public void TST_UCO_030_CS05()
        {
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string importFileToUploadPath = projectPath + "\\Data\\MissingColumnImportFile.txt";
        ...
        public void TST_UCO_030_CS07()
        {
            string handleMsg = "Mandatory \"Default Parent\" column header is missing";
            HtmlTableRow errorHandleMsg = ActiveBrowser.Find.ByXPath<HtmlTableRow>(string.Format(AppLocators.get("import_new_users_error_handler_missing_def_parent_col_msg_div"),handleMsg));
