...
namespace PSS_Automation
{
    ...
    public class TST_UCO_025 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_025_CS07()
        {
                        Pages.PS_HomePage.ReviewLeftNavLink.Click();
        }
    
        [CodedStep(@"Select file to upload whose required tag value is missed")]
        public void TST_UCO_025_CS08()
        {
                        string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
                        string importFileToUploadPath = projectPath + "\\Data\\MissingTagValueImportFile.txt";
