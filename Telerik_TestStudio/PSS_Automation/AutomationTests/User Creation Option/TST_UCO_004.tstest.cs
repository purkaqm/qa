...
namespace PSS_Automation
{
    ...
    public class TST_UCO_004 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_004_CS04()
        {
            Pages.PS_UserCreationOptionsPage.EnforceTagsAndCustomFieldsInvtiteUserChkbox.Click();
            ActiveBrowser.RefreshDomTree();
        }
        
        [CodedStep(@"Verify Save button becomes active")]
        public void TST_UCO_004_CS05()
        {
            Assert.IsTrue(Pages.PS_UserCreationOptionsPage.SaveBtn.IsEnabled);
            //Undo the changes
            Pages.PS_UserCreationOptionsPage.EnforceTagsAndCustomFieldsInvtiteUserChkbox.Click();
