...
namespace PSS_Automation
{
    ...
    public class TST_UCO_028 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_028_CS04()
        {
                Pages.PS_HomePage.ReviewLeftNavLink.Click();
        }
    
        [CodedStep(@"Select file to upload whose required group column is missed")]
        public void TST_UCO_028_CS05()
        {
        ...
        public void TST_UCO_028_CS07()
        {
                string handleMsg = "Mandatory \"Group\" column header is missing";
                HtmlTableRow errorHandleMsg = ActiveBrowser.Find.ByXPath<HtmlTableRow>(string.Format(AppLocators.get("import_new_users_error_handler_missing_grp_col_msg_div"),handleMsg));
