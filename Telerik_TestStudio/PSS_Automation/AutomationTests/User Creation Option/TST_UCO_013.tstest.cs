...
namespace PSS_Automation
{
    ...
    public class TST_UCO_013 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Turn on Require default work tree location on Invite New User column")]
        public void TST_UCO_013_CS02()
        {
        ...
        public void TST_UCO_013_CS04()
        {
            Pages.PS_HomePage.AddLeftNavLink.Click();
        }
    
        [CodedStep(@"Click on User tab")]
        public void TST_UCO_013_CS05()
        {
            Pages.PS_HomePage.AddUserTab.Click();
            ActiveBrowser.WaitUntilReady();
        }
    
        [CodedStep(@"Verify default Work Tree section is displayed with red dot")]
        public void TST_UCO_013_CS06()
        {
            Assert.IsTrue(Pages.PS_InviteCreateNewUserPage.AddUserGroupsRedDotImage.IsVisible(),"Default Work Tree section should be displayed with red dot");
        }
    }
}
