...
namespace PSS_Automation
{
    ...
    public class TST_UCO_026 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_026_CS07()
        {
            Pages.PS_HomePage.ReviewLeftNavLink.Click();
        }
    
        [CodedStep(@"Select file to upload whose Required CF column is missed")]
        public void TST_UCO_026_CS08()
        {
