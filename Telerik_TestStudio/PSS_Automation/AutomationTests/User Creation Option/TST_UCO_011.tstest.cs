...
namespace PSS_Automation
{
    ...
    public class TST_UCO_011 : BaseWebAiiTest
    {
        ...
        public void TST_UCO_011_CS06()
        {
            Pages.PS_HomePage.AddLeftNavLink.Click();
        }
    
        [CodedStep(@"Click on User tab")]
        public void TST_UCO_011_CS07()
        {
            Pages.PS_HomePage.AddUserTab.Click();
            ActiveBrowser.WaitUntilReady();
        }
    
        [CodedStep(@"Verify required 'Custom Field' is displayed with red dot")]
        public void TST_UCO_011_CS08()
        {
            ...
            Log.WriteLine(string.Format(AppLocators.get("Custom_field_red_dot_img"),GetExtractedValue("GeneratedCustomFieldName").ToString()));
            redDotCustumField.Wait.ForExists();
            Assert.IsTrue(redDotCustumField.IsVisible(),"Custom Field is displayed with red dot");
        }
       
        [CodedStep(@"Delete created custom tag")]
        public void TST_UCO_011_CS09()
        {
