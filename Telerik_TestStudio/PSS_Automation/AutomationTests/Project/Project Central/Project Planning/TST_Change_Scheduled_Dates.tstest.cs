...
namespace PSS_Automation
{
    ...
    public class TST_Change_Scheduled_Dates : BaseWebAiiTest
    {
        ...
        public void TS_Chnage_Planned_Date_CodedStep()
        {
            ...
            string startDateFieldLoc = string.Format(AppLocators.get("proj_plan_sched_start_date_field_div"), containerID,level,projectIndex);
            ...
            Log.WriteLine("start date to enter : " + startDateToEnter);
            ActiveBrowser.RefreshDomTree();
            ...
            string endDateFieldLoc = string.Format(AppLocators.get("proj_plan_sched_end_date_field_div"), containerID,level,projectIndex);
        ...
        public void TS_Chnage_Planned_Date_CodedStep1()
        {
            // Click 'Button0'
        ...
        public void TS_Chnage_Planned_Date_CodedStep2()
        {
            ActiveBrowser.RefreshDomTree();
            ActiveBrowser.WaitForAjax(Manager.Settings.ClientReadyTimeout);
        ...
        [CodedStep(@"New Coded Step")]
        public void TS_Change_Scheduled_Dates_CodedStep()
        {
