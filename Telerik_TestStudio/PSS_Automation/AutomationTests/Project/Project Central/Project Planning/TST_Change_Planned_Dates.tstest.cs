...
namespace PSS_Automation
{
    ...
    public class TST_Change_Planned_Dates : BaseWebAiiTest
    {
        ...
        public void TS_Chnage_Planned_Date_CodedStep()
        {
            ...
            string startDateFieldLoc = string.Format(AppLocators.get("proj_plan_pland_start_date_field_div"), containerID,level,projectIndex);
            ...
            string endDateFieldLoc = string.Format(AppLocators.get("proj_plan_pland_end_date_field_div"), containerID,level,projectIndex);
        ...
        [CodedStep(@"New Coded Step")]
        public void TS_Change_Planned_Dates_CodedStep()
        {
