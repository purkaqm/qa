...
namespace PSS_Automation
{
    ...
    public class TST_ML_006 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Select Delete on drop down menu near 'X_measure_template'")]
        public void TST_ML_006_CS04()
        {
        ...
        [CodedStep(@"Verify Delete popup is displayed")]
        public void TST_ML_006_CS05()
        {
            Assert.IsTrue(Pages.PS_ReviewMeasureLibrary.DeletePopupHeaderDiv.BaseElement.InnerText.Contains(measureName));
            Assert.IsTrue(Pages.PS_ReviewMeasureLibrary.DeletePopupCommitButton.IsVisible());                
