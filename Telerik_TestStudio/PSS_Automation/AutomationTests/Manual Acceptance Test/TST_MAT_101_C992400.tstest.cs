...
namespace PSS_Automation
{
    ...
    public class TST_MAT_101_C992400 : BaseWebAiiTest
    {
        ...
        public void TST_MAT_101_C992400_ClickAddNewButton()
        {
        ...
        public void TST_MAT_101_C992400_FillDetails()
        {
            //Enter url
        ...
        public void TST_MAT_101_C992400_ClickAddDocBtn()
        {
            Pages.PS_ManageImportantLinksPage.AddDocumentButton.Click();
        }
    
        [CodedStep(@"Click on Done button")]
        public void TST_MAT_101_C992400_ClickDoneBtn()
        {
        ...
        public void TST_MAT_101_C992400_VerifyLink()
        {
        ...
        [CodedStep(@"Verify added link is displayed in the left menu and Click to that link")]
        public void TST_MAT_101_C992400_VerifyLinkLeftMenu()
        {
        ...
        public void TST_MAT_101_C992400_VerifyNavigationLink()
        {
            Assert.IsTrue(ActiveBrowser.Url.Contains(Data["URL"].ToString()));
        }

        [CodedStep(@"Delete the generated link")]
        public void TST_MAT_101_C992400_DeleteLink()
        {
            ActiveBrowser.RefreshDomTree();
