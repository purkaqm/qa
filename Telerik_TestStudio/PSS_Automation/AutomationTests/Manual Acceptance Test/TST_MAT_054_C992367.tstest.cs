...
namespace PSS_Automation
{
    ...
    public class TST_MAT_054_C992367 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Upload image and Verify change is reflected in header bar ")]
        public void TST_MAT_054_C992367_UploadHeaderImageAndVerify()
        {
