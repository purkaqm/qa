...
namespace PSS_Automation
{
    ...
    public class TST_MAT_009_C992576 : BaseWebAiiTest
    {
        ...
        public void TST_MAT_008_C992576_ClickAdminLink()
        {
        ...
        public void TST_MAT_008_C992576_VerifyGrid()
        {
        ...
        public void TST_MAT_008_C992576_ClickAddNewTag()
        {
            Pages.PS_TagsListPage.AddNewTagBtn.Click();
        }
    
        [CodedStep(@"Verify new tag is created")]
        public void TST_MAT_008_C992576_VerifyNewTag()
        {
        ...
        public void TST_MAT_008_C992576_DeleteTag()
        {
        ...
        [CodedStep(@"Verify created Tag is disappear from the Grid")]
        public void TST_MAT_008_C992576_VerifyTagRemove()
        {
        
            ActiveBrowser.RefreshDomTree();
            Assert.IsNull(ActiveBrowser.Find.ByXPath<HtmlImage>(string.Format(AppLocators.get("delete_custom_tag_image"),GetExtractedValue("CustTagName").ToString())));
        }
    }
}
