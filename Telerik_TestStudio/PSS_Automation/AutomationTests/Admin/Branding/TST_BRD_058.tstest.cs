...
namespace PSS_Automation
{
    ...
    public class TST_BRD_058 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_058_CodedStep()
        {
            Pages.PS_BrandingLookAndFeelPage.TopNavIconHoverAcronymTag.Wait.ForExists();
            Pages.PS_BrandingLookAndFeelPage.TopNavIconHoverAcronymTag.Wait.ForVisible();
            Pages.PS_BrandingLookAndFeelPage.TopNavIconHoverAcronymTag.ScrollToVisible();
            Pages.PS_BrandingLookAndFeelPage.TopNavIconHoverAcronymTag.MouseHover();
            ActiveBrowser.RefreshDomTree();
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_058_CodedStep1()
        {
