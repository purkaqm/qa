...
namespace PSS_Automation
{
    ...
    public class TST_BRD_049 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_049_CodedStep()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_049_CodedStep1()
        {
            HtmlTableCell starMark = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_report_logo_star_mark"));
            starMark.Wait.ForExists();
            Assert.IsTrue(starMark.IsVisible()," starmark should be visible");
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_049_CodedStep2()
        {
