...
namespace PSS_Automation
{
    ...
    public class TST_BRD_117 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_117_CodedStep()
        {
        ...
        public void TST_BRD_117_CodedStep1()
        {
        ...
        [CodedStep(@"Upload ppt file with same name")]
        public void TST_BRD_117_CodedStep2()
        {
        ...
        public void TST_BRD_117_CodedStep3()
        {
            HtmlDiv errorMsg = ActiveBrowser.Find.ByXPath<HtmlDiv>(AppLocators.get("branding_powerpoint_error_msg"));
            errorMsg.Wait.ForExists();
            Assert.IsTrue(errorMsg.IsVisible(),"error message is shown: There is already a template with that name.");
        }
    }
}
