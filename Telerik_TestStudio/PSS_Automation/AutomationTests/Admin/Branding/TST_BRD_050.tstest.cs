...
namespace PSS_Automation
{
    ...
    public class TST_BRD_050 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_050_CodedStep()
        {
             HtmlTableCell clearImgLocHL = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_email_logo_clear_image_td_cell"));
            ...
            string imgToDownloadPath = projectPath1 + "\\Data\\Images\\downloadedLogoEL.png";
            ...
            Pages.PS_BrandingLookAndFeelPage.ReportLogoDownloadLink.Click();
            dialog.WaitUntilHandled(Manager.Settings.ElementWaitTimeout);
            Manager.Current.DialogMonitor.Stop(); 
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_050_CodedStep1()
        {
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string imgToDownloadPath = projectPath + "\\Data\\Images\\downloadedLogoEL.png";
