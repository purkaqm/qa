...
namespace PSS_Automation
{
    ...
    public class TST_BRD_123 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_123_CodedStep()
        {
        ...
        public void TST_BRD_123_CodedStep1()
        {
        ...
        public void TST_BRD_123_CodedStep2()
        {
        ...
        public void TST_BRD_123_CodedStep3()
        {
        ...
        [CodedStep(@"Click on No button")]
        public void TST_BRD_123_CodedStep4()
        {
            Pages.PS_BrandingPowerPointPage.DeletePopUpNoBtn.Wait.ForExists();
            Pages.PS_BrandingPowerPointPage.DeletePopUpNoBtn.Click();
            ActiveBrowser.WaitUntilReady();
        }
    
        [CodedStep(@"Verify template is not deleted")]
        public void TST_BRD_123_CodedStep5()
        {
            Assert.IsTrue(ActiveBrowser.Find.AllByXPath(GetExtractedValue("FileVarificationLoc").ToString()).Count > 0, "Template should be present");
        }
    }
}
