...
namespace PSS_Automation
{
    ...
    public class TST_BRD_004 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_004_CodedStep()
        {
            ...
            string imgToDownloadPath = projectPath1 + "\\Data\\Images\\downloadedLogoHL.png";
            ...
            Pages.PS_BrandingLookAndFeelPage.HeaderLogoDownloadLink.Click();
            dialog.WaitUntilHandled(Manager.Settings.ElementWaitTimeout);
            Manager.Current.DialogMonitor.Stop();
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_004_CodedStep1()
        {
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string imgToDownloadPath = projectPath + "\\Data\\Images\\downloadedLogoHL.png";
