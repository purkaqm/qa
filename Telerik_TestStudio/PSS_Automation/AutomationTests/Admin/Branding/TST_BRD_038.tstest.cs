...
namespace PSS_Automation
{
    ...
    public class TST_BRD_038 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_038_CodedStep()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_038_CodedStep1()
        {
            HtmlTableCell logoErrorLoc = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_login_logo_size_error_msg"));
            logoErrorLoc.Wait.ForExists();
            Assert.IsTrue(logoErrorLoc.IsVisible(),"Error message should be shown");
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_038_CodedStep2()
        {
