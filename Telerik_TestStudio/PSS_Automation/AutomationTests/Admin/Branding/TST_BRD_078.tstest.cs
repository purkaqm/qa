...
namespace PSS_Automation
{
    ...
    public class TST_BRD_078 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_078_CodedStep()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_078_CodedStep1()
        {
            
            selectedColor = Data["Select_Color_Content_Txt"].ToString();            
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_078_CodedStep2()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_078_CodedStep3()
        {
            HtmlControl contTxtLoc = ActiveBrowser.Find.ByXPath<HtmlControl>(AppLocators.get("branding_color_scheme_content_txt"));
            Assert.IsTrue(contTxtLoc.GetComputedStyle("color").Value.ToString().Contains(selectedColor));
        }
    }
}
