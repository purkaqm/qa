...
namespace PSS_Automation
{
    ...
    public class TST_BRD_118 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_118_CodedStep()
        {
        ...
        [CodedStep(@"Upload non ppt file")]
        public void TST_BRD_118_CodedStep1()
{
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string fileToUploadPath = projectPath + "\\Data\\TestFile";
