...
namespace PSS_Automation
{
    ...
    public class TST_BRD_075 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_075_CodedStep()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_075_CodedStep1()
        {
            selectedColor = Data["Select_Color_Left_Nav_Icon_Highlight"].ToString();            
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_075_CodedStep2()
        {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_075_CodedStep3()
        {
            ActiveBrowser.RefreshDomTree();
            Pages.PS_HomePage.AdminLeftNavLink.MouseHover();
            System.Threading.Thread.Sleep(1000);
            Assert.IsTrue(Pages.PS_HomePage.AdminLeftNavLink.GetComputedStyle("color").Value.ToString().Contains(selectedColor),"selected color should be displayed on left navigation highlighting");
        }
    }
}
