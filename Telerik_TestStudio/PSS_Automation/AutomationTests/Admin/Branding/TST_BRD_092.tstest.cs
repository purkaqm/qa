...
namespace PSS_Automation
{
    ...
    public class TST_BRD_092 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_092_CodedStep()
        {
        ...
        public void TST_BRD_092_CodedStep1()
        {
        ...
        public void TST_BRD_092_CodedStep2()
        {
        ...
        public void TST_BRD_092_CodedStep3()
        {
        ...
        public void TST_BRD_092_CodedStep4()
        {
        ...
        public void TST_BRD_092_CodedStep5()
        {
        ...
        [CodedStep(@"Connect to pop-up window : '/help/HelpDesk.page'")]
        public void TST_BRD_092_CodedStep6()
        {
        ...
        public void TST_BRD_092_CodedStep7()
        {
            Pages.PS_HomePage.SubmitHelpDeskReqLink.Wait.ForExists();
            Pages.PS_HomePage.SubmitHelpDeskReqLink.Click();
        }
    
        [CodedStep(@"Verify Custom text is displayed on the resulting page")]
        public void TST_BRD_092_CodedStep8()
        {
            ...
            Assert.IsTrue(customTxtLoc.InnerText.ToString().Contains(GetExtractedValue("MsgText").ToString()),"Custom message should be shown in submit help desk request page");
        }
    }
}
