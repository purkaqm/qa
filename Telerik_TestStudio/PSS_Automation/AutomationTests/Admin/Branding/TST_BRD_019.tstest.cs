...
namespace PSS_Automation
{
    ...
    public class TST_BRD_019 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_019_CodedStep()
        {
             ...
             Assert.IsTrue(!preImage.Equals(currImg), "header logo high contrast should be changed after upload...");  
             }
             else{
                 Assert.IsTrue(Pages.PS_BrandingLookAndFeelPage.HeaderLogoHcImg.IsVisible(),"header logo hihg contrast should be visible");
             }
        }
    }
}
