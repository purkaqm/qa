...
namespace PSS_Automation
{
    ...
    public class TST_BRD_005 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Upload sample logo image and verify that image is dispalyed in previev frame")]
        public void TST_BRD_005_CodedStep()
        {
            ...
            Pages.PS_BrandingLookAndFeelPage.HeaderLogoErrorTableCell.Wait.ForExists();
            Assert.IsTrue(Pages.PS_BrandingLookAndFeelPage.HeaderLogoErrorTableCell.IsVisible(),"error message should be displayed");
