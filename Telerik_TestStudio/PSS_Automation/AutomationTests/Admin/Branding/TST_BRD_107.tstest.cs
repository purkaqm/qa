...
namespace PSS_Automation
{
    ...
    public class TST_BRD_107 : BaseWebAiiTest
    {
        ...
        {
            Assert.IsTrue(Pages.PS_BrandingCustomMessages.SystemInvEmailMailBodyTextArea.BaseElement.InnerText.Contains(GetExtractedValue("MsgText").ToString()));
        }
    }
}
