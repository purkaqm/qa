...
namespace PSS_Automation
{
    ...
    public class TST_BRD_028 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_030_CodedStep1()
        {
            HtmlTableCell logoErrorLoc = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_print_logo_size_error_msg"));
            logoErrorLoc.Wait.ForExists();
            Assert.IsTrue(logoErrorLoc.IsVisible(),"Error message should be shown");
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_030_CodedStep2()
        {
