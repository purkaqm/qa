...
namespace PSS_Automation
{
    ...
    public class TST_BRD_032 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_032_CodedStep()
        {
             HtmlTableCell clearImgLocHL = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_login_logo_clear_image_td_cell"));
            ...
            string imgToDownloadPath = projectPath1 + "\\Data\\Images\\downlaoded_logoLL.png";
            ...
            Pages.PS_BrandingLookAndFeelPage.LoginLogoDownloadLink.Click();
            dialog.WaitUntilHandled(Manager.Settings.ElementWaitTimeout);
            Manager.Current.DialogMonitor.Stop();
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_032_CodedStep1()
        {
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string imgToDownloadPath = projectPath + "\\Data\\Images\\downlaoded_logoLL.png";
            Assert.IsTrue(System.IO.File.Exists(imgToDownloadPath),"login logo image file should be present in directory");
