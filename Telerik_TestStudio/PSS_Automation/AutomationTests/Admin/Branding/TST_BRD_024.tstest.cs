...
namespace PSS_Automation
{
    ...
    public class TST_BRD_024 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_024_CodedStep()
        {
             ...
             Assert.IsTrue(!preImage.Equals(currImg), "print logo should be changed after upload...");  
                 ...
                 Assert.IsTrue(Pages.PS_BrandingLookAndFeelPage.LoginLogoImg.IsVisible(),"print logo should be visible");
             }          
        }
    }
}
