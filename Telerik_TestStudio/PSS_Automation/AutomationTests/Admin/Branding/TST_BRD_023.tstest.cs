...
namespace PSS_Automation
{
    ...
    public class TST_BRD_023 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_023_CodedStep()
        {
             HtmlTableCell clearImgLocHL = ActiveBrowser.Find.ByXPath<HtmlTableCell>(AppLocators.get("branding_clear_image_print_logo_table_cell"));
            ...
            string imgToDownloadPath = projectPath1 + "\\Data\\Images\\downloaded_logoPL.png";
            ...
            Pages.PS_BrandingLookAndFeelPage.PrintLogoDownloadLink.Click();
            dialog.WaitUntilHandled(Manager.Settings.ElementWaitTimeout);
            Manager.Current.DialogMonitor.Stop();
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_023_CodedStep1()
        {
            string projectPath = this.ExecutionContext.DeploymentDirectory.ToString();
            string imgToDownloadPath = projectPath + "\\Data\\Images\\downloaded_logoPL.png";
            Assert.IsTrue(System.IO.File.Exists(imgToDownloadPath),"print logo image file should be present in directory");
