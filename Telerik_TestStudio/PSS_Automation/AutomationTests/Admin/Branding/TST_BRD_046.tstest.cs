...
namespace PSS_Automation
{
    ...
    public class TST_BRD_046 : BaseWebAiiTest
    {
        ...
        public void TST_BRD_046_CodedStep()
        {
             if(Pages.PS_BrandingLookAndFeelPage.EmailLogoImg.IsVisible()){ 
             string prevImg = Pages.PS_BrandingLookAndFeelPage.EmailLogoImg.BaseElement.GetAttribute("src").Value.ToString();             
             ...
             Pages.PS_BrandingLookAndFeelPage.EmailLogoImg.Wait.ForVisible();
             string currImg = Pages.PS_BrandingLookAndFeelPage.EmailLogoImg.BaseElement.GetAttribute("src").Value.ToString();
             ...
             Assert.IsTrue(!preImage.Equals(currImg), "email logo should be changed after upload...");  
                 ...
                 Assert.IsTrue(Pages.PS_BrandingLookAndFeelPage.EmailLogoImg.IsVisible(),"email logo should be visible");
             }       
        }
    
        [CodedStep(@"New Coded Step")]
        public void TST_BRD_046_CodedStep1()
        {
