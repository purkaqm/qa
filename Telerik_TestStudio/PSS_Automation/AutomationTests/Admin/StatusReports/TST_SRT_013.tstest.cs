...
namespace PSS_Automation
{
    ...
    public class TST_SRT_013 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Verify status report template record is removed from the table")]
        public void CS_SRT_013_02()
        {
                        ...
                        Assert.IsTrue(ActiveBrowser.Find.AllByXPath(expectedSRTRecordLocator).Count == 0, "SRT record from table should be removed");
        }
    }
}
