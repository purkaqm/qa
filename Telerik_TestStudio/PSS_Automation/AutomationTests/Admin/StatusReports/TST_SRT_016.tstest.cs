...
namespace PSS_Automation
{
    ...
    public class TST_SRT_016 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Click Down Arrow to see Template Options")]
        public void CS_SRT_016_02()
        {
        ...
        [CodedStep(@"Verify Statistics, Edit and Delete options are available")]
        public void CS_SRT_016_03()
        {
                        ...
                        Assert.IsTrue(Pages.PS_StatusReportTemplatesPage.SRTRecordDeleteTab.IsVisible(),"Delete option should be present");
                        Assert.IsTrue(Pages.PS_StatusReportTemplatesPage.SRTRecordEditTab.IsVisible(),"Edit option should be present");
                        Assert.IsTrue(Pages.PS_StatusReportTemplatesPage.SRTRecordStatisticsTab.IsVisible(),"Statistics option should be present");
                      
        }
        
        [CodedStep(@"Delete given SRT")]
        public void CS_SRT_016_04()
        {
