...
namespace PSS_Automation
{
    ...
    public class TST_IH_021 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Verify user should found and user name is listed as link and Click on user name")]
        public void TST_IH_021_CS10()
        {
        ...
        [CodedStep(@"Verify user get an error message")]
        public void TST_IH_021_CS12()
        {
                        Assert.IsTrue(Pages.PS_AddIdeaHopperPage.ErrorAddIdeaHopperDiv.IsVisible());  
                        Assert.IsTrue(Pages.PS_AddIdeaHopperPage.ErrorAddIdeaHopperDiv.InnerText.Contains("Please choose a location.")); 
        }
    }
}
