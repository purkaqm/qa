...
namespace PSS_Automation
{
    ...
    public class TST_IH_009 : BaseWebAiiTest
    {
        ...
        public void TST_IH_009_CS17()
        {
            ...
            {
                Log.WriteLine("Delete the" + ideaHopperName + " manualy " + ex.Message );
