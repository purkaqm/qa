...
namespace PSS_Automation
{
    ...
    public class TST_HMC_022 : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter new user")]
        public void CS_HMC_022_01()
        {
        ...
        public void CS_HMC_022_02()
        {
            Pages.PS_ResourcePoolsPage.AddNewBtn.Wait.ForExists();
            Pages.PS_ResourcePoolsPage.AddNewBtn.Click();
            ActiveBrowser.WaitUntilReady();
            Pages.PS_ResourcePoolAddNewPage.PoolNameInputField.Wait.ForExists();
            Pages.PS_ResourcePoolAddNewPage.SaveChangesBtn.Wait.ForExists();
        }
    
        [CodedStep(@"Create new resource pool with created user added")]
        public void CS_HMC_022_03()
        {
                        
            string poolName = "AutoPool"+Randomizers.generateRandomInt(10000,99999);
            ActiveBrowser.Window.SetFocus();
            Actions.SetText(Pages.PS_ResourcePoolAddNewPage.PoolNameInputField,poolName);
            Actions.SetText(Pages.PS_ResourcePoolAddNewPage.PoolDescriptionTextArea,"Sample Pool Description");
            
            
            Actions.SetText(Pages.PS_ResourcePoolAddNewPage.SearchUserInputField,GetExtractedValue("CreatedUserName").ToString());
            Pages.PS_ResourcePoolAddNewPage.GoBtn.Click();
            ActiveBrowser.WaitForAjax(Manager.Settings.ElementWaitTimeout);
            System.Threading.Thread.Sleep(5000);
            ActiveBrowser.RefreshDomTree(); 
            
            
            Pages.PS_ResourcePoolAddNewPage.SearchedUserLink.Wait.ForExists();
            Pages.PS_ResourcePoolAddNewPage.SearchedUserLink.Wait.ForVisible();
            
            Pages.PS_ResourcePoolAddNewPage.SearchedUserLink.DragTo(Pages.PS_ResourcePoolAddNewPage.PoolAddedUserArea);
            System.Threading.Thread.Sleep(3000);
            
            Pages.PS_ResourcePoolAddNewPage.SaveChangesBtn.Click();
            ActiveBrowser.WaitUntilReady();
            
            //Pages.PS_ResourcePoolsPage.AddNewBtn.Wait.ForExists();
            
            SetExtractedValue("GeneratedPoolName",poolName);
                
        }
    
        [CodedStep(@"Click Add new configuration link")]
        public void CS_HMC_022_04()
        {
        ...
        public void CS_HMC_022_11()
        {
             Pages.PS_HomePageConfigurationsPage.HomePageToUseDropdown.SelectByText(GetExtractedValue("GeneratedHMCName").ToString(), true);
                                      
        }
    
        [CodedStep(@"Select resource pool option from Users dropdowns")]
        public void CS_HMC_022_12()
        {
                Pages.PS_HomePageConfigurationsPage.UsersDropdown.SelectByValue("RESOURCE_POOL", true);
                ActiveBrowser.WaitForAjax(Manager.Settings.ElementWaitTimeout);
                ActiveBrowser.RefreshDomTree(); 
        ...
        [CodedStep(@"Select newly created pool")]
        public void CS_HMC_022_13()
        {
               Pages.PS_HomePageConfigurationsPage.ResourcePoolSelect.SelectByText(GetExtractedValue("GeneratedPoolName").ToString(), true);
                        
        }
    
        [CodedStep(@"Click OK and Confirm Home Page Selection")]
        public void CS_HMC_022_14()
        {
