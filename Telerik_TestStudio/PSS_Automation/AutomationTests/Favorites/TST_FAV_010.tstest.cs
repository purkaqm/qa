...
namespace PSS_Automation
{
    ...
    public class TST_FAV_010 : BaseWebAiiTest
    {
        ...
        public void TST_FAV_010_CodedStep()
        {
        ...
        public void TST_FAV_010_CodedStep1()
        {
        ...
        //public void TST_FAV_010_CodedStep2()
        //{
        ...
        //public void TST_FAV_010_CodedStep3()
        //{
           
            //string attr = ActiveBrowser.Actions.InvokeScript("document.getElementById(\"addToFavouritesName\").value;").ToString();
            //string layoutName = GetExtractedValue("LayoutPageTitle").ToString();
            //Assert.IsTrue(attr.Equals(layoutName), "Name field should be pre populated with Selected Portfolio Name");
           //Pages.PS_HomePage.AddToFavDialogCancelButton.Click();
        //}
    }
}
