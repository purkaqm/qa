...
import static com.powersteeringsoftware.libs.enums.page_locators.AdvancedSearchPageLocators.EMAIL_INPUT_FIELD;
import static com.powersteeringsoftware.libs.enums.page_locators.AdvancedSearchPageLocators.PHONE_INPUT_FIELD;
 ...
 * @author karina
 */
public class PeopleASPage extends AbstractASPage {

    @Override
    public void open() {
        openAdvancedSearch().openPeopleTab();
    }

    public void setEmail(String email) {
        new Input(EMAIL_INPUT_FIELD).type(email);
    }

    public void setPhoneNumber(String phoneNumber) {
        new Input(PHONE_INPUT_FIELD).type(phoneNumber);
    }
